                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form action="" method="post" class="space-y-6">
                            ...
                            <div id="review-text" class="w-full">
                                <div class="mt-4">
                                    <textarea id="review-text" name="description" rows="5"
                            ...
                            <button type="button" data-modal-hide="write-review-modal"
    ...
    <div id="review-section" class="w-full md:w-1/2">
        @foreach ($reviews as $review)
            <div class="mb-8">
                ...
                <p id="review-text" class="mt-2 text-sm text-gray-600">
                    {{ $review->review_text }}
                </p>
            </div>
        @endforeach
